export const Hero = () => {
    return (
        <div className="bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] py-24">
            <div className="container">
                ...
                <h1 className=" text-center text-4xl md:text-6xl md:leading-[70px] font-bold tracking-tighter max-w-[950px] mx-auto bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-5 py-2">
                ...
                <p className="text-center text-[22px] leading-[30px] tracking-tight text-[#010D3E] mt-5 max-w-[720px] mx-auto">
                    Helping Founders and Early-Stage Startups build Fully Functional Responsive Websites for 1/3 of the Cost and get 3x Conversions.
                </p>
